METADATA
last updated: 2026-04-15_183458
...
# _archive-combined-files_fl-fda-correspondence_44k (13 files, 43,661 tokens)

# 5,839  _AI_FDA Deprioritization of COVID-19 Diagnostic EUAs.md
METADATA
last updated: 2026-03-02 AI
...
- Is it acceptable to utilize the FloodLAMP EasyPCR(TM) COVID-19 Test for determining the pass/fail of specimen adequacy? No, these studies should be designed to support the usability of the test that is subject of the EUA.
...
1\. FloodLAMP QuickColor(TM) COVID-19 Test for the qualitative detection of RNA from SARS-CoV-2 in upper respiratory specimens including nasopharyngeal swabs, anterior nasal and mid-turbinate nasal swabs from individuals suspected of COVID-19 by their healthcare provider and from individuals without symptoms or other epidemiological reasons to suspect COVID-19 infection, when such individuals are tested as part of a testing program that includes testing at regular intervals, at least once per week.
...
3\. FloodLAMP EasyPCR(TM) COVID-19 Test is a real-time reverse transcriptase polymerase chain reaction (RT-PCR) assay intended for the qualitative detection of RNA from SARS-CoV-2 in upper respiratory specimens including nasopharyngeal swabs, anterior nasal and mid-turbinate nasal swabs from individuals suspected of COVID-19 by their healthcare provider and from individuals without symptoms or other epidemiological reasons to suspect COVID-19 infection, when such individuals are tested as part of a testing program that includes testing at regular intervals, at least once per week.
...
- As stated in our template, FDA believes a minimum of 95% positive and negative agreement is acceptable clinical performance. The FloodLAMP QuickColor(TM) COVID-19 Test demonstrated a lower PPA than what FDA believes is acceptable for this use. Therefore, we do not recommend pursuing an EUA for this test unless you can improve its sensitivity.
