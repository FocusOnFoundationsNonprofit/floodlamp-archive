...
summary_short: The "2023-03-24_FDA Website - Transition Plan for Medical Devices" document announces final March 24, 2023 guidances that lay out how medical devices covered by COVID-19 enforcement policies or issued COVID-19 EUAs should transition back to normal regulatory operations. It highlights FDA recommendations to create a transition implementation plan, prepare and submit an appropriate marketing submission, and take other follow-on actions, with links to the guidances and an April 18, 2023 webinar for stakeholders.
