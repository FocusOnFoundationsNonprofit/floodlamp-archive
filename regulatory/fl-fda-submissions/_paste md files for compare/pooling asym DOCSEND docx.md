...
Inclusion Criteria
Exclusion Criteria
The specimen is an anterior nasal swab using the swab and QR code labeled tubes, nasal swabs included with the FloodLAMP Pooled Swab Collection Kit DTC.
...
The swab specimen can be tested within 56 hours or less after collection. If frozen, specimens are to be stored at <-70℃ until tested.
The specimen was not collected under informed consent.
