...
All four primers for both CoV-19 and RNase P detection may be purchased from the vendor Eurofins Genomics using the catalog number 12YS-010YST. This product contains primers and probes suspended at 100μM and is enough for 12,500 reactions. This kit can be mixed along with nuclease-free water to create the primer stock used in the FloodLAMP EasyPCRTM COVID-19 Test. See Table 6 below for details. A larger volume of primer-probe stock can be prepared in advance and stored at \-20oC for up to 1 year.
